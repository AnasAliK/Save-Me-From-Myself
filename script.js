    ...
    boss: {
        whatsapp: [
            { id: 'wife1', title: 'Late Dinner', msgs: [
                ...
                {type:'sent',text:"okeh, I am stopping at the corner stor.",mistakes:[{o:"okeh",c:"okay",l:["okay","key"]},{o:"stor",c:"store",l:["store","star"]}]},
            ...
            { id: 'contractor', title: 'Renovation', msgs: [
                ...
                {type:'sent',text:"Good, the budget is aready over the limit.",mistakes:[{o:"aready",c:"already",l:["already","ready"]}]},
        ...
        imessage: [
            { id: 'hr_manager', title: 'Hiring', msgs: [
                ...
                {type:'sent',text:"Pefect, bring the files and a pen for me.",mistakes:[{o:"Pefect",c:"Perfect",l:["Perfect","fect"]}]},
            ...
            { id: 'it_dept', title: 'Laptop Issue', msgs: [
                ...
                {type:'sent',text:"Just do it quickly, I have no pateince today.",mistakes:[{o:"pateince",c:"patience",l:["patience","patients"]}]},
        ...
        twitter: [
            { id: 'pr1', title: 'Company Vision', msgs: [
                ...
                {type:'sent',text:"Mostly bots so far, nothing reel.",mistakes:[{o:"reel",c:"real",l:["real","reel"]}]},
        ...
        discord: [
            { id: 'dev_chat', title: 'Sprint Review', msgs: [
                ...
                {type:'sent',text:"I will chek the progress in two hours.",mistakes:[{o:"chek",c:"check",l:["check","cheek"]}]},
                ...
                {type:'sent',text:"Send the bill to the offiice account.",mistakes:[{o:"offiice",c:"office",l:["office","ice"]}]},
            ...
            { id: 'marketing_hub', title: 'Ad Spend', msgs: [
                ...
                {type:'sent',text:"Stick to what works for now, avaid risk.",mistakes:[{o:"avaid",c:"avoid",l:["avoid","void"]}]},
                {type:'recv',text:"Understood boss."},
                {type:'sent',text:"I want a sumnary of the ROI by Friday.",mistakes:[{o:"sumnary",c:"summary",l:["summary","marry"]}]},
        ...
        tinder: [
            { id: 'date_match', title: 'Coffee?', msgs: [
                ...
                {type:'sent',text:"I am a very busy person with many respoisbilities.",mistakes:[{o:"respoisbilites",c:"responsibilities",l:["responsibilities","ability"]}]},
                ...
                {type:'sent',text:"I must check my calander for any gaps.",mistakes:[{o:"calander",c:"calendar",l:["calendar","end"]}]},
            ...
            { id: 'new_match', title: 'Interests', msgs: [
                ...
                {type:'sent',text:"Yes, mostly for buisnes but some pleasure.",mistakes:[{o:"buisnes",c:"business",l:["business","ness"]}]},
    ...
    sportsman: {
        ...
        twitter: [
            { id: 'gym_beef', title: 'Call Out', msgs: [
                ...
                {type:'sent',text:"Who tokd you that? I was deep in the zone today.",mistakes:[{o:"tokd",c:"told",l:["told","toll"]}]},
                {type:'recv',text:"The guys at the desk said you only did cardio."},
                {type:'sent',text:"They are hatrz, my legs are litrally tree trunks.",mistakes:[{o:"hatrz",c:"haters",l:["haters","hates"]},{o:"litrally",c:"literally",l:["literally","liter"]}]},
        ...
        discord: [
            { id: 'supps_talk', title: 'The Stack', msgs: [
                ...
                {type:'sent',text:"I mixd three today, my skin is itchy as hell.",mistakes:[{o:"mixd",c:"mixed",l:["mixed","mix"]}]},
            ...
            { id: 'training_vids', title: 'Form Check', msgs: [
                ...
                {type:'sent',text:"Stay consisent and results will come soon.",mistakes:[{o:"consisent",c:"consistent",l:["consistent","tent"]}]}
            ]}
        ],
        tinder: [
            { id: 'gym_match', title: 'Fit Match', msgs: [
                ...
                {type:'sent',text:"Maybe on a cheat day, but I prefer orotien.",mistakes:[{o:"orotien",c:"protein",l:["protein","teen"]}]},
            ...
            { id: 'active_date', title: 'Hike?', msgs: [
                ...
                {type:'sent',text:"Every Sonday morning to clear my head.",mistakes:[{o:"Sonday",c:"Sunday",l:["Sunday","day"]}]},
                ...
                {type:'sent',text:"I can go slow if you went to join me.",mistakes:[{o:"went",c:"want",l:["want","went"]}]},
                {type:'recv',text:"Are there bears?"},
                {type:'sent',text:"I am not afeaid of bears, I am a beast.",mistakes:[{o:"afeaid",c:"afraid",l:["afraid","raid"]}]},
                ...
                {type:'sent',text:"I dnt drink coffee, only black tea for me.",mistakes:[{o:"dnt",c:"don't",l:["don't","dent"]}]},
    ...
    kid: {
        whatsapp: [
            { id: 'mom_chat', title: 'Mom', msgs: [
                ...
                {type:'sent',text:"i forrgot i was busy playing football",mistakes:[{o:"forrgot",c:"forgot",l:["forgot","got"]}]},
                ...
                {type:'sent',text:"is it piza tonight? i hope it is",mistakes:[{o:"piza",c:"pizza",l:["pizza","piza"]}]},
                {type:'recv',text:"It's vegetables and fish."},
                {type:'sent',text:"eww i hate fish so much can i eat latar",mistakes:[{o:"latar",c:"later",l:["later","late"]}]},
                ...
                {type:'sent',text:"no i have it in my bag dont worri",mistakes:[{o:"worri",c:"worry",l:["worry","sorry"]}]},
                {type:'recv',text:"See you in 5."},
                {type:'sent',text:"see ya soon baye bye mom",mistakes:[{o:"baye",c:"bye",l:["bye","by"]}]},
                {type:'recv',text:"Bye."},
                {type:'sent',text:"weit can i buy a soda on the way",mistakes:[{o:"weit",c:"wait",l:["wait","weight"]}]}
            ]},
            { id: 'best_friend', title: 'Kyle', msgs: [
                ...
                {type:'sent',text:"i need to save mney for it fast",mistakes:[{o:"mney",c:"money",l:["money","monkey"]}]},
                ...
                {type:'sent',text:"meth is so hard i hate algebra so much",mistakes:[{o:"meth",c:"math",l:["math","maths"]}]},
                ...
                {type:'sent',text:"cool i want to see it eight now",mistakes:[{o:"eight",c:"right",l:["right","write"]}]},
        ...
        imessage: [
            { id: 'sister_kid', title: 'Sis', msgs: [
                ...
                {type:'sent',text:"fine yes i ate it it was testy",mistakes:[{o:"testy",c:"tasty",l:["tasty","taste"]}]},
                {type:'recv',text:"I'm so mad."},
                {type:'sent',text:"i will give u my desert tonight ok",mistakes:[{o:"desert",c:"dessert",l:["dessert","desert"]}]},
                {type:'recv',text:"Deal."},
                {type:'sent',text:"u are so meen to me sometimes",mistakes:[{o:"meen",c:"mean",l:["mean","main"]}]},
            ...
            { id: 'dad_kid', title: 'Dad', msgs: [
                ...
                {type:'sent',text:"im dooing them right now dad i swear",mistakes:[{o:"dooing",c:"doing",l:["doing","dong"]}]},
                {type:'recv',text:"I checked the bin, it's still full."},
                {type:'sent',text:"i was just abut to take it out",mistakes:[{o:"abut",c:"about",l:["about","out"]}]},
                ...
                {type:'sent',text:"fine i am turining it off now sry",mistakes:[{o:"turining",c:"turning",l:["turning","turn"]}]},
                {type:'recv',text:"Thank you. We're going to the park later."},
                {type:'sent',text:"can i bring my skatebaoard please",mistakes:[{o:"skatebaoard",c:"skateboard",l:["skateboard","board"]}]},
                {type:'recv',text:"Yes, but wear your helmet."},
                {type:'sent',text:"helmet is for babyes its not cool",mistakes:[{o:"babyes",c:"babies",l:["babies","baby"]}]},
                {type:'recv',text:"No helmet, no park."},
                {type:'sent',text:"ok ok i will weaar the helmet dad",mistakes:[{o:"weaar",c:"wear",l:["wear","war"]}]},
        ...
        twitter: [
            { id: 'game_fan', title: 'Fan Talk', msgs: [
                ...
                {type:'sent',text:"oh then it mst be the guy from team A",mistakes:[{o:"mst",c:"must",l:["must","mist"]}]},
                ...
                {type:'sent',text:"im in diemond level right now bro",mistakes:[{o:"diemond",c:"diamond",l:["diamond","mind"]}]},
                ...
                {type:'sent',text:"dont call me kid im almost a tean",mistakes:[{o:"tean",c:"teen",l:["teen","ten"]}]}
            ]},
            { id: 'meme_lord', title: 'Funny Post', msgs: [
                {type:'recv',text:"Did you see that funny meme?"},
                {type:'sent',text:"om yes i was laughing so hard",mistakes:[{o:"om",c:"omg",l:["omg","dog"]}]},
                {type:'recv',text:"I shared it on my wall."},
                {type:'sent',text:"i will go and like it reight now",mistakes:[{o:"reight",c:"right",l:["right","write"]}]},
                ...
                {type:'sent',text:"about how hard school msth is lol",mistakes:[{o:"msth",c:"math",l:["math","maths"]}]},
                ...
                {type:'sent',text:"ok find one with a cryieng face",mistakes:[{o:"cryieng",c:"crying",l:["crying","ring"]}]},
                ...
                {type:'sent',text:"i will share it to all my freinds",mistakes:[{o:"freinds",c:"friends",l:["friends","ends"]}]},
                {type:'recv',text:"Don't forget to tag me."},
                {type:'sent',text:"i wont i will give u credit bro",mistakes:[{o:"wont",c:"won't",l:["won't","want"]}]},
                {type:'recv',text:"Let's go."},
                {type:'sent',text:"it is gona be a masterpleice",mistakes:[{o:"masterpleice",c:"masterpiece",l:["masterpiece","piece"]}]}
            ]}
        ],
        discord: [
            { id: 'gaming_rage', title: 'Ranked Match', msgs: [
                ...
                {type:'sent',text:"the server is trash i swear i hitt him",mistakes:[{o:"hitt",c:"hit",l:["hit","hat"]}]},
                {type:'recv',text:"We’re going to lose our rank because of you."},
                {type:'sent',text:"dont be so salti its just a game bro",mistakes:[{o:"salti",c:"salty",l:["salty","salt"]}]},
                ...
                {type:'sent',text:"eating piza and gaming is hard okay",mistakes:[{o:"piza",c:"pizza",l:["pizza","piza"]}]},
            ...
            { id: 'trade_scam', title: 'Item Trade', msgs: [
                ...
                {type:'sent',text:"what will u gove me for it bro",mistakes:[{o:"gove",c:"give",l:["give","gave"]}]},
                ...
                {type:'sent',text:"wait i need to check the prices frist",mistakes:[{o:"frist",c:"first",l:["first","fist"]}]},
                ...
                {type:'sent',text:"if u add one mroe skin i will do it",mistakes:[{o:"mroe",c:"more",l:["more","sore"]}]},
                {type:'recv',text:"Fine, I'll add the blue gloves."},
                {type:'sent',text:"ok now we have a deel send it",mistakes:[{o:"deel",c:"deal",l:["deal","dual"]}]},
                {type:'recv',text:"Sending now."},
                {type:'sent',text:"i am waiting for the notificton",mistakes:[{o:"notificton",c:"notification",l:["notification","cat"]}]},
                {type:'recv',text:"Check your inventory."},
                {type:'sent',text:"omg it workd thanks for the trade",mistakes:[{o:"workd",c:"worked",l:["worked","word"]}]},
        ...
        tinder: [
            { id: 'crush_kid', title: 'School Crush', msgs: [
                ...
                {type:'sent',text:"hyi i was just bored so i made one",mistakes:[{o:"hyi",c:"hi",l:["hi","hie"]}]},
                {type:'recv',text:"Do you go to the same school?"},
                {type:'sent',text:"yeah i see u in the hellway sometimes",mistakes:[{o:"hellway",c:"hallway",l:["hallway","way"]}]},
                ...
                {type:'sent',text:"yeah that is me i lve football",mistakes:[{o:"lve",c:"love",l:["love","live"]}]},
                {type:'recv',text:"You're actually pretty good."},
                {type:'sent',text:"thnaks i train every single day after school",mistakes:[{o:"thnaks",c:"thanks",l:["thanks","tanks"]}]},
                ...
                {type:'sent',text:"want to hung out this saturday",mistakes:[{o:"hung",c:"hang",l:["hang","hangs"]}]},
                {type:'recv',text:"Ask me on Friday."},
                {type:'sent',text:"ok i will wait until then b",mistakes:[{o:"b",c:"bye",l:["bye","by"]}]}
            ]},
            { id: 'mystery_match', title: 'New Friend', msgs: [
                ...
                {type:'sent',text:"dogs can play cetch and go for walks",mistakes:[{o:"cetch",c:"catch",l:["catch","cash"]}]},
                ...
                {type:'sent',text:"i have to do my hw on sonday sry",mistakes:[{o:"sonday",c:"sunday",l:["sunday","day"]}]},
                ...
                {type:'sent',text:"ok i will bring my dpg with me",mistakes:[{o:"dpg",c:"dog",l:["dog","log"]}]},
    ...
    girl: {
        whatsapp: [
            { id: 'tea_time', title: 'Group Chat', msgs: [
                ...
                {type:'sent',text:"Everyone knows, she is so dellusinal lol.",mistakes:[{o:"dellusinal",c:"delusional",l:["delusional","fusion"]}]},
                ...
                {type:'sent',text:"Money is meant to be spent bestei.",mistakes:[{o:"bestei",c:"bestie",l:["bestie","best"]}]},
            ...
            { id: 'vacay_plans', title: 'Summer Trip', msgs: [
                ...
                {type:'sent',text:"Bali is so aestetic, I love it!",mistakes:[{o:"aestetic",c:"aesthetic",l:["aesthetic","static"]}]},
                {type:'recv',text:"It's a bit expensive though."},
                {type:'sent',text:"We can find a cheap airnnb if we look now.",mistakes:[{o:"airnnb",c:"airbnb",l:["airbnb","air"]}]},
        ...
        imessage: [
            { id: 'mom_girl', title: 'Home late', msgs: [
                ...
                {type:'sent',text:"oh right i forgit i took an uber here",mistakes:[{o:"forgit",c:"forgot",l:["forgot","got"]}]},
                {type:'recv',text:"Why did you take an Uber?"},
                {type:'sent',text:"my car was acting weirdy so i was scared",mistakes:[{o:"weirdy",c:"weirdly",l:["weirdly","word"]}]},
                ...
                {type:'sent',text:"no she is steying here she is tired",mistakes:[{o:"steying",c:"staying",l:["staying","stay"]}]},
            ...
            { id: 'crush_girl', title: 'Friday Night', msgs: [
                ...
                {type:'sent',text:"noting much just hanging out with friends",mistakes:[{o:"noting",c:"nothing",l:["nothing","thing"]}]},
                ...
                {type:'sent',text:"oh i hate horror movies they are so scairy",mistakes:[{o:"scairy",c:"scary",l:["scary","scar"]}]},
                ...
                {type:'sent',text:"ok i need to find a cute outfut now",mistakes:[{o:"outfut",c:"outfit",l:["outfit","fit"]}]},
                {type:'recv',text:"You always look great."},
                {type:'sent',text:"thanks u are so swit to me",mistakes:[{o:"swit",c:"sweet",l:["sweet","sweat"]}]},
                {type:'recv',text:"Should I get popcorn?"},
                {type:'sent',text:"yes and some candi too please",mistakes:[{o:"candi",c:"candy",l:["candy","can"]}]},
                ...
                {type:'sent',text:"we will see about that bey bye",mistakes:[{o:"bey",c:"bye",l:["bye","by"]}]}
            ]}
        ],
        twitter: [
            { id: 'fashion_tweet', title: 'New Look', msgs: [
                ...
                {type:'sent',text:"it was a bit prilcey but worth it",mistakes:[{o:"prilcey",c:"pricey",l:["pricey","price"]}]},
                ...
                {type:'sent',text:"just some simple heals i found online",mistakes:[{o:"heals",c:"heels",l:["heels","hell"]}]},
                {type:'recv',text:"Can you send me the link?"},
                {type:'sent',text:"i will find it and dm it to u latr",mistakes:[{o:"latr",c:"later",l:["later","late"]}]},
                ...
                {type:'sent',text:"thanks bye for now bestei",mistakes:[{o:"bestei",c:"bestie",l:["bestie","best"]}]}
            ]},
            { id: 'drama_tweet', title: 'The Tea', msgs: [
                {type:'recv',text:"Did you hear what happened at the party?"},
                {type:'sent',text:"om no tell me everything right now",mistakes:[{o:"om",c:"omg",l:["omg","dog"]}]},
                {type:'recv',text:"Sarah and Jake had a huge fight."},
                {type:'sent',text:"i knew it they are so toxuc together",mistakes:[{o:"toxuc",c:"toxic",l:["toxic","tick"]}]},
                ...
                {type:'sent',text:"i wish i was there to see it meself",mistakes:[{o:"meself",c:"myself",l:["myself","self"]}]},
                {type:'recv',text:"It's all over TikTok now."},
                {type:'sent',text:"i need to go and find the vido fast",mistakes:[{o:"vido",c:"video",l:["video","void"]}]},
                ...
                {type:'sent',text:"i will text u the details later bey",mistakes:[{o:"bey",c:"bye",l:["bye","by"]}]}
            ]}
        ],
        discord: [
            { id: 'study_group', title: 'Exam Prep', msgs: [
                ...
                {type:'sent',text:"i hate this class so much its booring",mistakes:[{o:"booring",c:"boring",l:["boring","born"]}]},
                ...
                {type:'sent',text:"i hope so i need a good gradde mom",mistakes:[{o:"gradde",c:"grade",l:["grade","grad"]}]},
                {type:'recv',text:"Did you read the textbook?"},
                {type:'sent',text:"only the first two pages i got slepy",mistakes:[{o:"slepy",c:"sleepy",l:["sleepy","sleep"]}]},
                ...
                {type:'sent',text:"ugh he is so wird but ok lets go",mistakes:[{o:"wird",c:"weird",l:["weird","word"]}]},
            ...
            { id: 'music_bot', title: 'Party Vibes', msgs: [
                ...
                {type:'sent',text:"i am ading some pop hits right now",mistakes:[{o:"ading",c:"adding",l:["adding","ding"]}]},
                {type:'recv',text:"No heavy metal please."},
                {type:'sent',text:"i hate metal mussic its too loud sry",mistakes:[{o:"mussic",c:"music",l:["music","sick"]}]},
                {type:'recv',text:"This song is a banger."},
                {type:'sent',text:"i know right i lve this artist so much",mistakes:[{o:"lve",c:"love",l:["love","live"]}]},
                ...
                {type:'sent',text:"i dont care i will save all my moneyy",mistakes:[{o:"moneyy",c:"money",l:["money","monkey"]}]},
                ...
                {type:'sent',text:"lets dence in the voice room lol",mistakes:[{o:"dence",c:"dance",l:["dance","dace"]}]}
            ]}
        ],
        tinder: [
            { id: 'date_match_girl', title: 'First Chat', msgs: [
                {type:'recv',text:"Your eyes are beautiful."},
                {type:'sent',text:"thnaks i get that a lot haha",mistakes:[{o:"thnaks",c:"thanks",l:["thanks","tanks"]}]},
                {type:'recv',text:"What are you looking for here?"},
                {type:'sent',text:"just meeting new people and havng fun",mistakes:[{o:"havng",c:"having",l:["having","hang"]}]},
                {type:'recv',text:"I'm looking for something serious."},
                {type:'sent',text:"that is nice i like honeesty in a guy",mistakes:[{o:"honeesty",c:"honesty",l:["honesty","nest"]}]},
                {type:'recv',text:"What's your favorite food?"},
                {type:'sent',text:"i lve sushi and italian food so much",mistakes:[{o:"lve",c:"love",l:["love","live"]}]},
                ...
                {type:'sent',text:"ok i will find a cute drrss for us",mistakes:[{o:"drrss",c:"dress",l:["dress","press"]}]},
            ...
            { id: 'casual_match', title: 'Hey!', msgs: [
                ...
                {type:'sent',text:"really maybe we have mutal friends",mistakes:[{o:"mutal",c:"mutual",l:["mutual","dual"]}]},
                {type:'recv',text:"I think I saw you at the gym."},
                {type:'sent',text:"i go to the gym every mornig early",mistakes:[{o:"mornig",c:"morning",l:["morning","ring"]}]},
                {type:'recv',text:"I go in the evenings."},
                {type:'sent',text:"evenings are too bussy for me i hate it",mistakes:[{o:"bussy",c:"busy",l:["busy","bus"]}]},
                {type:'recv',text:"What's your routine?"},
                {type:'sent',text:"i do a lot of cardio and some weigts",mistakes:[{o:"weigts",c:"weights",l:["weights","eight"]}]},
                ...
                {type:'sent',text:"u are very sweat to say that thanks",mistakes:[{o:"sweat",c:"sweet",l:["sweet","sweat"]}]},
